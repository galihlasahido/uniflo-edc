...
public class TransferActivityEnhanced extends AppCompatActivity {
    
    private static final String TAG = "TransferEnhanced";
    ...
    private void initViews() {
        ...
        // tvTransferType.setText("Transfer Type: Bank Transfer");
        // tvTransferType.setVisibility(View.VISIBLE);
    }
    ...
    private void setupListeners() {
        btnTransfer.setOnClickListener(v -> validateAndProceed());
    }
        ...
        ServiceManager.bindPosServer(this, new OnServiceConnectCallback() {
            ...
            public void onSuccess() {
                ...
                if (icReader == null) {
                    ...
                    Toast.makeText(TransferActivityEnhanced.this, 
    ...
    private void validateAndProceed() {
        ...
        destinationAccount = etAccountNumber.getText().toString().trim();
        if (destinationAccount.isEmpty()) {
            tilAccountNumber.setError("Please enter account number");
            return;
        }
        
        if (destinationAccount.length() < 10) {
            tilAccountNumber.setError("Account number must be at least 10 digits");
            return;
        }
        ...
        try {
            transferAmount = Long.parseLong(amountStr);
            if (transferAmount <= 0) {
            ...
            if (transferAmount > 50000000) { // 50 million IDR limit
                tilAmount.setError("Amount exceeds maximum transfer limit");
                return;
            }
    ...
    private void showTransferConfirmation() {
        ...
        new androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setMessage("Transfer Details:\n\n" +
                       "To Account: " + destinationAccount + "\n" +
                       "Amount: " + formatter.format(transferAmount) + "\n\n" +
    ...
    private void showCardInsertDialog() {
        ...
        NumberFormat formatter = NumberFormat.getCurrencyInstance(new Locale("id", "ID"));
        tvMessage.setText("Transfer: " + formatter.format(transferAmount) + "\n" +
    ...
    private void showPinInputDialog(String cardType) {
        runOnUiThread(() -> {
            ...
            if (cardInsertDialog != null) {
                ...
                TextView detailsDisplay = new TextView(this);
                detailsDisplay.setTextSize(16);
                detailsDisplay.setGravity(android.view.Gravity.CENTER);
                NumberFormat formatter = NumberFormat.getCurrencyInstance(new Locale("id", "ID"));
                detailsDisplay.setText("Transfer: " + formatter.format(transferAmount) + "\n" +
                                     "To: " + destinationAccount);
                detailsDisplay.setTextColor(android.graphics.Color.BLACK);
                detailsDisplay.setPadding(0, 0, 0, 16);
                pinLayout.addView(detailsDisplay);
    ...
    private void collectTLVDataAndProcessWithPin(String cardType, String pin) {
        ...
        new Thread(() -> {
            try {
                ...
                Map<String, String> emvTlvData = emvUtil.generateARQC(transferAmount, pinBlockBytes);
                
                // Override transaction type for transfer
                emvTlvData.put(EMVUtil.TAG_TRANSACTION_TYPE, "40"); // Transfer
                ...
                tlvData.put("ProcessingCode", "400000"); // Transfer
                tlvData.put("Amount", String.format("%012d", transferAmount));
                ...
                tlvData.put("DestinationAccount", destinationAccount);
                tlvData.put("TransferType", "01"); // Bank transfer
        ...
        runOnUiThread(() -> {
            ...
            new Thread(() -> {
                try {
                    ...
                    String urlString = String.format("%s://%s:%d/api/transfer",
                    ...
                    try {
                        ...
                        if (responseCode == HttpURLConnection.HTTP_OK) {
                            ...
                            addDebugLog("✅ Transfer successful");
                            ...
                            runOnUiThread(() -> {
                                progressDialog.dismiss();
                                handleCardError("Transfer failed: " + responseCode);
                            });
                        }
                    ...
                    runOnUiThread(() -> {
                        progressDialog.dismiss();
                        handleCardError("Transfer error: " + e.getMessage());
                    });
                }
            }).start();
        });
    ...
    private void showTransactionSuccess(String response) {
        ...
        intent.putExtra("transaction_type", "Transfer");
        NumberFormat formatter = NumberFormat.getCurrencyInstance(new Locale("id", "ID"));
        intent.putExtra("amount", formatter.format(transferAmount));
        intent.putExtra("reference", tlvData.get("STAN"));
        intent.putExtra("destination", destinationAccount);
